...
function postData() {
    ...
    fetch(urlBase, {
        ...
        .catch(error => console.log('Error en el intento de crear el posteo: ', error))
}
    ...
    fetch(`${urlBase}/${id}`, {
        ...
        .then(data => {
            ...
            if (index != -1) {
                ...
                alert('Hubo un error al actualizar la informacion')
            }
            renderPostList()
        })
        .catch(error => console.log('Error en el intento de actualizar el posteo: ', error))
}
